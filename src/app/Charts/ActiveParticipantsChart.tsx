...
const UserNodeData = [9836, 870047, 1571043, 2067822, 2693455, 3140922, 3376680, 3687612, 4076770, 4561988, 5398672, 6281094, 7034910, 7743910, 8469040, 9581094, 10584901, 11485109, 12567903]

export default function ActiveParticipantsChart() {
